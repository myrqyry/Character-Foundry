...
// Use the local icon library — avoids pulling in the @heroicons/react production dependency.
...
// Memoised row component so that re-renders of the parent (e.g. from a sibling state
// change) don't trigger expensive date formatting for every row in the list.
const VersionRow = memo(({ version, isCurrent, onRestore }: VersionRowProps) => (
  <div 
